...
SOLR_BIN_DIR=$PWD/solr
SOLR_KEYSTORE_DIR=$SOLR_BIN_DIR/keystores
SOLR_SSL_TRUST_STORE=$SOLR_KEYSTORE_DIR/ssl.repo.client.truststore
SOLR_SSL_TRUST_STORE_PASSWORD=password
SOLR_SSL_TRUST_STORE_TYPE=JCEKS
SOLR_SSL_KEY_STORE=$SOLR_KEYSTORE_DIR/ssl.repo.client.keystore
SOLR_SSL_KEY_STORE_PASSWORD=password
SOLR_SSL_KEY_STORE_TYPE=JCEKS
SOLR_SSL_NEED_CLIENT_AUTH=true
SOLR_OPTS="$SOLR_OPTS -Dalfresco.encryption.ssl.keystore.location=$SOLR_KEYSTORE_DIR/ssl.repo.client.keystore"
SOLR_OPTS="$SOLR_OPTS -Dalfresco.encryption.ssl.keystore.passwordFileLocation=$SOLR_KEYSTORE_DIR/ssl-keystore-passwords.properties"
SOLR_OPTS="$SOLR_OPTS -Dalfresco.encryption.ssl.keystore.type=JCEKS"
SOLR_OPTS="$SOLR_OPTS -Dalfresco.encryption.ssl.keystore.provider= "
SOLR_OPTS="$SOLR_OPTS -Dalfresco.encryption.ssl.truststore.location=$SOLR_KEYSTORE_DIR/ssl.repo.client.truststore"
SOLR_OPTS="$SOLR_OPTS -Dalfresco.encryption.ssl.truststore.passwordFileLocation=$SOLR_KEYSTORE_DIR/ssl-truststore-passwords.properties"
SOLR_OPTS="$SOLR_OPTS -Dalfresco.encryption.ssl.truststore.type=JCEKS"
SOLR_OPTS="$SOLR_OPTS -Dalfresco.encryption.ssl.truststore.provider= "
